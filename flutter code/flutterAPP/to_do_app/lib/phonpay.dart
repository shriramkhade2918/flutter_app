...
import 'package:to_do_app/model/ImageSliderModel.dart';
import 'package:to_do_app/model/Listpaymodel.dart';
...
//                          color: Colors.deepPurple[700],
  ...
  List<Listpaymodel> _getMoneyTransferList() {
    List<Listpaymodel> list = [];
    list.add(new Listpaymodel("assets/request_money.png", "To Contact"));
    list.add(new Listpaymodel(
      "assets/ic_menu_balance_selected.png",
      "To Account",
    ));
    list.add(new Listpaymodel(
      "assets/request_money.png",
  ...
  List<Listpaymodel> _getSentMoneyList() {
    List<Listpaymodel> list = [];
    list.add(new Listpaymodel(
      "assets/placeholder_contact_provider.png",
      "Shreyansh",
    ));
    list.add(new Listpaymodel(
      "assets/placeholder_contact_provider.png",
